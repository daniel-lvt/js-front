...
export default function BasicGrid({ ...args }) {
    const { departamentData = [], ageGroupData = [], dataDB = [] } = args;
    ...
    const onClickEvent = () => {
        const dataResult = lodash.groupBy((dataFilter.length ? dataFilter : dataDB), 'GRUPO ETARÍO')
        const dataObject = (ageGroupData || []).map((key, idx) => ({
            prop: {
                label: key,
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            <Div>Accidentes producidos por Grupo Etario</Div>
                            ...
                            <Pie data={{
                                ...
                                options={{
                                    plugins: {
                                        title: {
                                            display: true,
                                            text: `Numero de accidentes Producidos por Armas Medio ${nameDepartament.length > 0 ? ` - ${nameDepartament}` : ''}`,
                                        },
                                        legend: {
                                            position: 'bottom',
                                        },
                            ...
                            <Bar
                                options={{
                                    ...
                                    plugins: {
                                        ...
                                        title: {
                                            display: true,
                                            text: 'Numero de accidentes Producidos por Armas Medio',
                                        },
                                    },
                                }}
                                data={{
